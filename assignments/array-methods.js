...
let allCaps = [];
runners.forEach(NewName => {
    let upperName = NewName.first_name.toUpperCase();
    // console.log(upperName);
    allCaps.push(upperName);
})
console.log(allCaps);
...
let largeShirts = [];
runners.forEach(large => {
    if (large.shirt_size === 'L') {
        let largeshirt = `${large.first_name} ${large.last_name} ${large.shirt_size}`;
